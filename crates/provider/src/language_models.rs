...
impl Models {
    ...
    pub fn to_string(&self) -> String {
        match self {
            ...
            Models::Amazon(m) => m.to_string(),
            Models::Anthropic(m) => m.to_string(),
            Models::ArceeAi(m) => m.to_string(),
            Models::Cohere(m) => m.to_string(),
            Models::Deepseek(m) => m.to_string(),
            Models::Google(m) => m.to_string(),
            Models::Inception(m) => m.to_string(),
            Models::Meituan(m) => m.to_string(),
            Models::Meta(m) => m.to_string(),
            Models::Minimax(m) => m.to_string(),
            Models::Mistral(m) => m.to_string(),
            Models::MoonshotAi(m) => m.to_string(),
            Models::Morph(m) => m.to_string(),
            Models::OpenAi(m) => m.to_string(),
            Models::Perplexity(m) => m.to_string(),
            Models::PrimeIntellect(m) => m.to_string(),
            Models::Stealth(m) => m.to_string(),
            Models::Vercel(m) => m.to_string(),
            Models::Xai(m) => m.to_string(),
            Models::Zai(m) => m.to_string(),
            Models::Custom(s) => s.clone(),
        }
    }
